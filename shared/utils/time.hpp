...
//  auto mm = std::chrono::duration_cast<std::chrono::minutes>(format_me % std::chrono::hours(1)).count();
//  auto ss = std::chrono::duration_cast<std::chrono::seconds>(format_me % std::chrono::minutes(1)).count();
//  auto mi = std::chrono::duration_cast<std::chrono::milliseconds>(format_me % std::chrono::seconds(1)).count();
//
...
inline std::string time_format(const std::chrono::milliseconds format_me) {
  auto hh = std::chrono::duration_cast<std::chrono::hours>(format_me).count();
  auto mm = std::chrono::duration_cast<std::chrono::minutes>(format_me % std::chrono::hours(1)).count();
  auto ss = std::chrono::duration_cast<std::chrono::seconds>(format_me % std::chrono::minutes(1)).count();
  auto mi = std::chrono::duration_cast<std::chrono::milliseconds>(format_me % std::chrono::seconds(1)).count();
